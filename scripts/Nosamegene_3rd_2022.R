...
net_GSE5847<-network(data=data_merged_GSE5847, Adj_type="signed", cortype="pearson", pval="none", thr=0.05, beta=6, comp1="_1", comp2="_2", doTOM=F, ds=4, crossOnly=T)
net_GSE10797<-network(data=data_merged_GSE10797, Adj_type="signed", cortype="pearson", pval="none", thr=0.05, beta=6, comp1="_1", comp2="_2", doTOM=F, ds=4, crossOnly=T)
net_GSE14548<-network(data=data_merged_GSE14548, Adj_type="signed", cortype="pearson", pval="none", thr=0.05, beta=6, comp1="_1", comp2="_2", doTOM=F, ds=4, crossOnly=T)
net_GSE83591<-network(data=data_merged_GSE83591, Adj_type="signed", cortype="pearson", pval="none", thr=0.05, beta=6, comp1="_1", comp2="_2", doTOM=F, ds=4, crossOnly=T)
net_GSE68744<-network(data=data_merged_GSE68744, Adj_type="signed", cortype="pearson", pval="none", thr=0.05, beta=6, comp1="_1", comp2="_2", doTOM=F, ds=4, crossOnly=T)
net_GSE88715<-network(data=data_merged_GSE88715, Adj_type="signed", cortype="pearson", pval="none", thr=0.05, beta=6, comp1="_1", comp2="_2", doTOM=F, ds=4, crossOnly=T)

nets<-list(net_GSE5847, net_GSE10797, net_GSE14548, 
           net_GSE83591, net_GSE68744, net_GSE88715)

save(nets, file="results/nets_3rd_new.RData")
