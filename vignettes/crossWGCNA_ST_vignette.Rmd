...
```{r, include=T, warning=FALSE, message=F}
ST_expr_smooth_out <- ST_expr_smooth(expr_data=expr_data, 
                                        coords=coords, 
                                        max_dist=5, 
                                        spots_class=class, 
                                        sel_class=c("Epi", "Stroma"))

# uncomment to download and load pre-computed object
# options(timeout=100)
...
# load("~/ST_expr_smooth_output.RData")
```
...
md <- ST_merged_dataset(sel_spots=sf, 
                        coords=coords, 
                        averaged_expr_all=ST_expr_smooth_out, 
                        var_thr=0.75, 
                        comp1="_tis1", 
                        comp2="_tis2")
```
